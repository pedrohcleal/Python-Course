...
>
> -3 instalar py32bits
> 3 instalar Visual Studio 2015 Update 3, Visual C++ Build Tools for Visual Studio 2015 Update 3
...
>    * Build the Library ``nmake`` basta escrever nmake e dar enter
>   *executar o comando pip install ta-lib no cmd e prontin
