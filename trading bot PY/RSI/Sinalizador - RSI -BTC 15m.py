...
def on_open(ws):
    ...
    client.chat_postMessage(channel='#btc-15min', text="Sinalizador-bot entrou em operação")
    ...
    if is_candle_closed:
        ...
        if len(closes) > RSI_PERIOD:
            ...
            if last_rsi > RSI_OVERBOUGHT:
                ...
                client.chat_postMessage(channel='#btc-15min',
            ...
            if RSI_OVERSOLD < last_rsi and RSI_OVERBOUGHT > last_rsi:
                if in_position:
                    ...
                    client.chat_postMessage(channel='#btc-15min', text="O indicador RSI entrou em zona neutra"
